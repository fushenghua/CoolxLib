...
import com.rtmap.library.db.sqlite.CursorUtils;
import com.rtmap.library.db.sqlite.DbModelSelector;
import com.rtmap.library.db.sqlite.Selector;
import com.rtmap.library.db.sqlite.SqlInfo;
import com.rtmap.library.db.sqlite.SqlInfoBuilder;
import com.rtmap.library.db.sqlite.WhereBuilder;
import com.rtmap.library.db.table.DbModel;
import com.rtmap.library.db.table.Id;
import com.rtmap.library.db.table.Table;
import com.rtmap.library.db.table.TableUtils;
import com.rtmap.library.exception.DbException;
import com.rtmap.library.utils.IOUtils;
...
public class CooDb {
     ...
     * key: dbName
     */
    private static HashMap<String, CooDb> daoMap = new HashMap<String, CooDb>();
    ...
    private CooDb(DaoConfig config) {
        if (config == null) {
    ...
    private synchronized static CooDb getInstance(DaoConfig daoConfig) {
        CooDb dao = daoMap.get(daoConfig.getDbName());
        if (dao == null) {
            dao = new CooDb(daoConfig);
    ...
    public static CooDb create(Context context) {
        DaoConfig config = new DaoConfig(context);
        return getInstance(config);
    }

    public static CooDb create(Context context, String dbName) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
        return getInstance(config);
    }

    public static CooDb create(Context context, String dbDir, String dbName) {
        DaoConfig config = new DaoConfig(context);
    ...
    public static CooDb create(Context context, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
    ...
    public static CooDb create(Context context, String dbDir, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbDir(dbDir);
        config.setDbName(dbName);
        config.setDbVersion(dbVersion);
    ...
    public static CooDb create(DaoConfig daoConfig) {
        return getInstance(daoConfig);
    }

    public CooDb configDebug(boolean debug) {
        this.debug = debug;
        return this;
    }

    public CooDb configAllowTransaction(boolean allowTransaction) {
    ...
    public interface DbUpgradeListener {
        public void onUpgrade(CooDb db, int oldVersion, int newVersion);
    }
