...
package com.rtmap.library.db.table;

import android.text.TextUtils;

import com.rtmap.library.db.annotation.Check;
import com.rtmap.library.db.annotation.NotNull;
import com.rtmap.library.db.annotation.Transient;
import com.rtmap.library.db.annotation.Unique;
import com.rtmap.library.db.converter.ColumnConverter;
import com.rtmap.library.db.converter.ColumnConverterFactory;
import com.rtmap.library.db.sqlite.FinderLazyLoader;
import com.rtmap.library.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static String getColumnNameByField(Field field) {
        com.rtmap.library.db.annotation.Column column = field.getAnnotation(com.rtmap.library.db.annotation.Column.class);
        if (column != null && !TextUtils.isEmpty(column.column())) {
            return column.column();
        }

        com.rtmap.library.db.annotation.Id id = field.getAnnotation(com.rtmap.library.db.annotation.Id.class);
        if (id != null && !TextUtils.isEmpty(id.column())) {
            return id.column();
        }

        com.rtmap.library.db.annotation.Foreign foreign = field.getAnnotation(com.rtmap.library.db.annotation.Foreign.class);
        if (foreign != null && !TextUtils.isEmpty(foreign.column())) {
            return foreign.column();
        }

        com.rtmap.library.db.annotation.Finder finder = field.getAnnotation(com.rtmap.library.db.annotation.Finder.class);
        if (finder != null) {
    ...
    public static boolean isForeign(Field field) {
        return field.getAnnotation(com.rtmap.library.db.annotation.Foreign.class) != null;
    }

    public static boolean isFinder(Field field) {
        return field.getAnnotation(com.rtmap.library.db.annotation.Finder.class) != null;
    }
    ...
    public static Class<?> getForeignEntityType(com.rtmap.library.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.rtmap.library.db.table.Finder finderColumn) {
